...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    Validates email, password confirmation, and creates a new CustomUser
    instance with the provided credentials.
    """
    ...
    def validate(self, attrs):
        ...
        Args:
            attrs: Dictionary containing email, password, and confirmed_password
    ...
    def create(self, validated_data):
        ...
        Args:
            validated_data: Dictionary with validated user data
